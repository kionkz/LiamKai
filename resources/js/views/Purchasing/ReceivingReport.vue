        ...
        <table class="items-table">
          ...
          <tbody>
            <tr v-for="(item, idx) in items" :key="idx">
              ...
              <td>{{ item.ordered }}</td>
              <td>
                <input v-model.number="item.received" type="number" min="0" :max="item.ordered" required placeholder="kg" />
              </td>
              <td>
                <input v-model.number="item.damaged" type="number" min="0" :max="item.ordered" placeholder="kg" />
              </td>
              <td>
                <input v-model.number="item.short" type="number" min="0" :max="item.ordered" @change="calculateShort(idx)" placeholder="kg" />
              </td>
            </tr>
          </tbody>
        </table>
